...
Главный сценарий: «Тиждень підготовки» для Grade 9 / Algebra I. В демо все данные статичны: макеты показывают, как задачи и итоги 50-минутного урока по квадратичным функциям могли бы выглядеть после подготовки ИИ и проверки преподавателем, без реальных API-запросов.

1. Быстрое закрепление в течение 24 часов после урока.
2. Ежедневная практика на 2–3 экзаменационные задачи с батарейками, зарядом подсказок и пропуском дня.
3. Разогрев за 10 минут до нового урока со шпаргалкой по квадратичным функциям, планом урока и тестовыми вводными примерами.

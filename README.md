...
Главный сценарий: «Неделя закрепления» для математики 5 класса США. В демо все данные статичны: макеты показывают, как задачи и итоги урока могли бы выглядеть после подготовки ИИ и проверки преподавателем, без реальных API-запросов.

1. Быстрое закрепление в течение 24 часов после урока.
2. Ежедневная практика на 2–3 задачи с батарейками, зарядом подсказок и пропуском дня.
